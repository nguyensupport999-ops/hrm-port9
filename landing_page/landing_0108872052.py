# -*- coding: utf-8 -*-
"""
landing_page/landing_0108872052.py
====================================
Landing Page RIÊNG của tenant có mã số thuế 0108872052 (Công ty Cổ phần Cảng
Hòn La).

QUY ƯỚC (giống cơ chế của landing_demo.py):
- app.py tự động nạp file này qua _load_tenant_module_or_demo('landing_page',
  'landing', ma_so_thue) khi tenant có mã số thuế 0108872052 đăng nhập.
- HỢP ĐỒNG BẮT BUỘC: file phải có hàm render() không nhận tham số — app.py chỉ gọi
  module.render(), không gọi gì khác. Toàn bộ nội dung chỉ dùng dữ liệu/tệp có sẵn
  trong phạm vi làm việc của Streamlit (COMPANY_CONFIG, thư mục static cục bộ),
  không thực hiện gọi mạng ra ngoài.
"""
...
def render():
    """Hiển thị Landing Page giới thiệu, hiển thị ở vùng nội dung chính (bên phải
    sidebar đăng nhập) khi CHƯA đăng nhập. Chỉ dùng dữ liệu/tệp có sẵn trong phạm
    vi làm việc của Streamlit (COMPANY_CONFIG, thư mục static cục bộ), không gọi
    ra ngoài mạng."""
    ...
    # Đọc file logo động - chỉ đọc tệp cục bộ trong phạm vi làm việc của Streamlit,
    # không gọi ra ngoài mạng.
    import base64
    logo_base64 = ""
    ...
    <nav class="navbar" id="navbar">
        <div class="nav-container">
            ...
            <div class="nav-links">
                <a class="nav-link" data-section="home">Trang chủ</a>
                <div class="dropdown">
                    <a class="nav-link" data-section="about">Giới thiệu <i class="fas fa-chevron-down"></i></a>
                    <div class="dropdown-content">
                        <a class="nav-link" data-section="about">Về chúng tôi</a>
                        <a href="#" id="thuNgoBtn">Thư ngỏ của Chủ tịch HĐQT</a>
                    </div>
                </div>
                <a class="nav-link" data-section="services">Dịch vụ</a>
                <a class="nav-link" data-section="infrastructure">Vị trí & Hạ tầng</a>
                <a class="nav-link" data-section="careers">Tuyển dụng</a>
                <a class="nav-link" data-section="contact">Liên hệ</a>
            </div>
        </div>
    </nav>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="a4-body">
                    ...
                    <p class="a4-greeting" style="font-weight: bold; font-size: 1rem;">Kính gửi: Quý đối tác, nhà đầu tư và toàn thể cán bộ nhân viên,</p>
                    ...
                    <p>Với vị trí địa chiến lược độc đáo, hệ thống hạ tầng quy mô 39,22 ha, năng lực tiếp nhận tàu trọng tải lên đến 70.000 DWT và tàu du lịch quốc tế 225.000 GT, Cảng tổng hợp quốc tế Hòn La sẽ là cửa ngõ hàng hải chiến lược, cầu nối giữa các nền kinh tế trong khu vực và toàn cầu.</p>
                    ...
                    <p>Chúng tôi hiểu rằng con đường phía trước còn không ít thách thức. Song Tôi tin tưởng sâu sắc rằng với trí tuệ tập thể, khí phách dân tộc và khát vọng vươn ra biển lớn, Cảng tổng hợp quốc tế Hòn La sẽ hoàn thành xuất sắc sứ mệnh lịch sử được giao phó.</p>
    ...
    <footer id="contact" class="footer">
        <div class="footer-grid">
            ...
            <div class="footer-col"><h4>Liên kết nhanh</h4>
                ...
                <a class="nav-link" data-section="about">Về chúng tôi</a>
                <a class="nav-link" data-section="services">Dịch vụ</a>
                <a class="nav-link" data-section="infrastructure">Hạ tầng</a>
                <a class="nav-link" data-section="careers">Tuyển dụng</a>
            </div>
        ...
        <div class="copyright">
            ...
            <p style="margin-top: 10px;">PHÁT TRIỂN BỀN VỮNG - KẾT NỐI TOÀN CẦU</p>
        </div>
    </footer>
